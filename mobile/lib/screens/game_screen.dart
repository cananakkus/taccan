      ...
      children: [
        ...
        Expanded(
          child: Row(
            ...
            children: [
              // Board left — tops aligned with game text
              const Expanded(flex: 55, child: GameBoard()),
              // Game text + controls right — same top as board
              Expanded(
                flex: 45,
                child: Column(
                  children: [
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: GoogleFonts.specialElite(color: colors.onSurface.withValues(alpha: 0.6)),
            ),
